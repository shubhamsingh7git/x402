...
export function OctagonBackground() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0 bg-[#f8f8f8] dark:bg-[#020202] transition-colors duration-700">
      ...
      */}
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_20%,#f8f8f8_80%)] dark:bg-[radial-gradient(ellipse_at_center,transparent_20%,#000000_80%)] opacity-90 transition-colors duration-700" />
